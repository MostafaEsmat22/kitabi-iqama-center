...
const rateLimitedQueryClient = {
  ...queryClient,
  query: withRateLimit(queryClient.query.bind(queryClient), 'api-query'),
  mutate: withRateLimit(queryClient.mutate.bind(queryClient), 'api-mutate'),
};
...
function App() {
  return (
    <ErrorBoundary>
      <HelmetProvider>
        <QueryClientProvider client={rateLimitedQueryClient}>
          <Helmet>
